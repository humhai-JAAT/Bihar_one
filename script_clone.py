...
col1, col2, col3, col4, col5 = st.columns([1,1.2,1.3,1.2,1.2])
with col1:
...
""")
    ...
    weights_data = {
        ...
        "Attribute": [
            "Aadhaar","Name","Date of Birth","Mobile Number","Gender","Father's Name",
            "Mother's Name","Permanent Address","Correspondence Address","Caste",
            "Marital Status","Education Status","Employment Status","Ration Card Number",
            "Ration Card Type","PAN ID","Bank Account","Land Ownership","Motor Ownership","Nationality"
        ],
        "Weight (%)": [18,9,9,7,3,6,4,8,4,4,2,2,2,5,2,5,4,3,2,1],
        "Match Type": [
            "Deterministic","Fuzzy + Phonetic","Exact > Year","OTP Verified","Exact","Fuzzy","Fuzzy",
            "Geo-normalized","Latest Timestamp","Certificate Verified","Registry Preferred",
            "Dept Certified","Statutory","Deterministic","Exact","Deterministic",
            "Masked Deterministic","Legal Title","Registration Match","Legal"
        ],
        "Enterprise Rule": [
            "UIDAI biometric verified","UIDAI > Civil Registry precedence","Civil Registry override",
            ...
            "Welfare classification","Income Tax authority","CBS source-of-origin",
            "Land Registry override","VAHAN verified","Civil Registry"
        ]
    }
